    ...
    <main className="min-h-screen bg-gray-50 pt-20">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Gerencie as suas informações pessoais e preferências</p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <nav className="space-y-1">
                ...
                {isAdmin && (
                  <Link
                    href="/admin"
                    className="flex items-center gap-3 px-4 py-3 rounded-xl text-yellow-600 hover:bg-yellow-50 transition-colors"
                  >
                ...
                <button
                  onClick={() => signOut()}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-yellow-600 hover:bg-yellow-50 transition-colors"
                >
          ...
          <div className="lg:col-span-3 space-y-6">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl border ${
                            errors.firstName ? 'border-yellow-300' : 'border-gray-200'
                      ...
                      <div>
                        ...
                        <input
                          {...register('lastName')}
                          className={`w-full px-4 py-3 rounded-xl border ${
                            errors.lastName ? 'border-yellow-300' : 'border-gray-200'
                          } focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent`}
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="bg-gray-900 text-white font-medium px-8 py-3 rounded-full hover:bg-gray-800 transition-colors disabled:opacity-50 flex items-center gap-2"
                      >
                        {isLoading ? (
                          <>
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6">
                  ...
                  <form className="space-y-5">
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        type="submit"
                        className="border border-gray-200 text-gray-700 font-medium px-8 py-3 rounded-full hover:bg-gray-50 transition-colors"
                      >
                        Alterar Palavra-passe
                      </button>
                    </div>
            ...
            {activeTab === 'settings' && (
              <div className="bg-white rounded-2xl shadow-sm p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Definições</h2>
                <div className="space-y-6">
                  <div className="flex items-center justify-between py-4 border-b border-gray-100">
                    <div>
                      <h3 className="font-medium text-gray-900">Notificações por Email</h3>
                      <p className="text-sm text-gray-500">Receber atualizações sobre novos imóveis</p>
                    </div>
                  ...
                  <div className="pt-6">
                    <h3 className="font-medium text-yellow-600 mb-2">Zona de Perigo</h3>
                    <p className="text-sm text-gray-500 mb-4">Eliminar permanentemente a sua conta e todos os dados associados.</p>
                    <button className="text-yellow-600 border border-yellow-200 font-medium px-6 py-2.5 rounded-full hover:bg-yellow-50 transition-colors">
                      Eliminar Conta
                    </button>
                  </div>
                </div>
